...
public:
    ...
    {
        mMaxIterations = glm::max(iterations, 1u);
    }
    ...
    {
        mWallMinSlideAngleDegrees = glm::clamp(degrees, 0.0f, 90.0f);
        mWallMinSlideAngleCosine = std::cos(glm::radians(mWallMinSlideAngleDegrees));
    }
    ...
    {
        mGroundSnapDistance = glm::max(distance, 0.0f);
    }
    ...
    {
        mStepOffset = glm::max(offset, 0.0f);
    }
