...
void testGrid()
{
    GridSource grid(Math::uvec3(3, 3, 3), Math::vec3(0), 1.0f, -1.0f);
    CHECK(grid.valid());
    ...
    GridSource brushTarget(Math::uvec3(4, 4, 4), Math::vec3(0), 1.0f, -1.0f);
    ...
    encoded.seek(0);
    GridSource restored(Math::uvec3(1), Math::vec3(99), 2.0f, 0.0f);
    ...
    truncated.seek(0);
    GridSource unchanged(Math::uvec3(1), Math::vec3(4), 3.0f, 7.0f);
