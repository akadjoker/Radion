...
void TextEditor::SetPalette(PaletteId aValue)
{
	...
	case PaletteId::RetroBlue:
		...
		break;
	case PaletteId::VsCodeDark:
		palletteBase = &(GetVsCodeDarkPalette());
		break;
	}
...
void TextEditor::SetFontScale(float aValue)
{
	mFontScale = Max(0.6f, Min(2.5f, aValue));
}
...
const TextEditor::Palette& TextEditor::GetVsCodeDarkPalette()
{
	const static Palette p = { {
			0xd4d4d4ff,	// Default
			0xc586c0ff,	// Keyword
			0xb5cea8ff,	// Number
			0xce9178ff,	// String
			0xd7ba7dff, // Char literal
			0xd4d4d4ff, // Punctuation
			0x569cd6ff,	// Preprocessor
			0x9cdcfeff, // Identifier
			0x4fc1ffff, // Known identifier
			0xdcdcaaFF, // Preproc identifier
			0x6a9955ff, // Comment (single line)
			0x6a9955ff, // Comment (multi line)
			0x1e1e1eff, // Background
			0xaeafadff, // Cursor
			0x264f7888, // Selection
			0xf4474780, // ErrorMarker
